...
@Component({
  selector: 'app-advance-tracking',
  templateUrl: './advance-tracking.component.html',
  styleUrls: ['./advance-tracking.component.less'],
  providers: [ScriptService]
})
export class AdvanceTrackingComponent implements OnInit {
  ...
  getTableData(){
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.documentApiService.getAllDocuments
          (
