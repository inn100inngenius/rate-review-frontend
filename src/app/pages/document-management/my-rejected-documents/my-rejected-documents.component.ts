...
@Component({
  selector: 'app-my-rejected-documents',
  templateUrl: './my-rejected-documents.component.html',
  styleUrls: ['./my-rejected-documents.component.less'],
  providers: [ScriptService]
})
export class MyRejectedDocumentsComponent implements OnInit {
  ...
  getTableData(){
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.documentApiService.getMyRejectedDocuments
          (
      ...
      {title:"status",
       data:null,
       render: function (data, type, row, meta) {
        let htm = '<span class="tx-medium tx-danger ">Rejected</span>';
