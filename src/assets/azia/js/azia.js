$(function(){
  ...
  $(document).on('click', '.az-header .dropdown > a', function (e) {
  ...
  $(document).on('click', '.az-navbar .with-sub', function (e) {
  ...
  $(document).on('click', '.dropdown-menu .az-header-arrow', function (e) {
  ...
  $(document).on('click', '#azNavShow, #azNavbarShow', function (e) {
  ...
  $(document).on('click touch', '#azContentLeftShow', function (e) {
  ...
  $(document).on('click touch', '#azContentLeftHide', function (e) {
  ...
  $(document).on('click touch', '#azContentBodyHide', function (e) {
  ...
  $(document).on('click touchstart', function(e){
    ...
    if(window.matchMedia('(min-width: 992px)').matches) {
      $(document).on('click','.az-menu-sub a', function(){
  ...
  $(document).on('click', '#azMenuShow', function (e) {
  ...
  $(document).on('click', '.az-header-menu .with-sub', function (e) {
  ...
  $(document).on('click', '.az-header-menu-header .close', function (e) {
